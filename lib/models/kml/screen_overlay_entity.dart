...
class ScreenOverlayEntity {
  ...
  /// Returns a [Map] from the current [ScreenOverlayEntity].
  ...
  /// Returns a [ScreenOverlayEntity] from the given [map].
  factory ScreenOverlayEntity.fromMap(Map<String, dynamic> map) {
    return ScreenOverlayEntity(
      name: map['name'],
      icon: map['icon'] ?? '',
